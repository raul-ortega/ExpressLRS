 ...
 */
void cartesian_to_polar_coordinates(int32_t dlat, int32_t dlon, int32_t *out_phi_deg, int32_t *out_radius_m)
{
    int8_t sign = 0;
    int32_t theta = 0;
    int32_t x = dlon;
 ...
 */
uint32_t format_home(uint32_t distance_to_home_m, uint32_t altitude_above_home_dm, uint8_t bearing_to_home_deg)
{
